...
class MultipleAppCell: UICollectionViewCell {
    ...
    fileprivate func setupViews() {
        ...
        seperatorView.anchor(top: nil, leading: nameLabel.leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: UIEdgeInsets(top: 0, left: 0, bottom: -8, right: 0), size: .init(width: 0, height: 0.5))
    }
}
