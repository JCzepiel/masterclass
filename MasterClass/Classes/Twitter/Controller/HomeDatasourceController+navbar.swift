...
extension HomeDatasourceController {
    ...
    func setupNavigationBarItems() {
        // During MasterClass implementation I removed this so we can see the back button and press back. This custom left button did nothing anyway
        //setupLeftNavItems()
        setupRightNavItems()
        setuRemainingNavItems()
    }

    private func setuRemainingNavItems() {
